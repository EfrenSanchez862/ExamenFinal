...
public class Tabla_Productos extends javax.swing.JFrame {
    ...
    Connection con = cc.getConexion();
        ...
        String[] titulos = {"idProducto", "Nombre_Producto", "Descripcion", "Fecha_Vencimineto", "Presio_Venta", "Stock"};
        ...
        try {
            ...
            while (rs.next()) {
                ...
                registros[3] = rs.getString("Fecha_Vencimineto");
                registros[4] = rs.getString("Presio_Venta");
    ...
    private void initComponents() {
        ...
        TableProd.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "idProducto", "Nombre_Producto", "Descripcion", "Fecha_Vencimiento", "Presio_Venta", "Stock"
            }
        ));
